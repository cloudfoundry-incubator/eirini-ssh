...
//TODO: Replace bbs client with a  kubeclient
...
func (pb *permissionsBuilder) Build(logger lager.Logger, processGuid string, index int, metadata ssh.ConnMetadata) (*ssh.Permissions, error) {
	...
	*/
	return pb.createPermissions()
}

func (pb *permissionsBuilder) createPermissions() (*ssh.Permissions, error) {
	/*
	...
	*/
	...
	return &ssh.Permissions{
		CriticalOptions: map[string]string{
			"proxy-target-config": "", // TODO: Check if we actually need this to be a config
			"log-message":         "Successful connection",
		},
	}, nil
}
